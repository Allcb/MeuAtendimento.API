using MeuAtendimento.Domain.Core.DTO;
using MeuAtendimento.Domain.Core.Enum;
using MeuAtendimento.Infra.CrossCutting.Helpers;
using MeuAtendmento.Infra.CrossCutting.ExceptionHandler.Extensions;
...
namespace MeuAtendmento.Infra.CrossCutting.ExceptionHandler.Providers
{
